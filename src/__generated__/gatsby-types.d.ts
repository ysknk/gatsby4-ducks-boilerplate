...
type SiteSiteMetadata = {
  ...
  readonly bodyClass: Maybe<Scalars['String']>;
  readonly lang: Maybe<Scalars['String']>;
  readonly viewport: Maybe<Scalars['String']>;
  readonly formatDetection: Maybe<Scalars['String']>;
  readonly keywords: Maybe<Scalars['String']>;
  readonly url: Maybe<Scalars['String']>;
  readonly ogLocale: Maybe<Scalars['String']>;
  readonly ogTitle: Maybe<Scalars['String']>;
  readonly ogDescription: Maybe<Scalars['String']>;
  readonly ogType: Maybe<Scalars['String']>;
  readonly ogUrl: Maybe<Scalars['String']>;
...
type SiteSiteMetadataFilterInput = {
  ...
  readonly bodyClass: Maybe<StringQueryOperatorInput>;
  readonly lang: Maybe<StringQueryOperatorInput>;
  readonly viewport: Maybe<StringQueryOperatorInput>;
  readonly formatDetection: Maybe<StringQueryOperatorInput>;
  readonly keywords: Maybe<StringQueryOperatorInput>;
  readonly url: Maybe<StringQueryOperatorInput>;
  readonly ogLocale: Maybe<StringQueryOperatorInput>;
  readonly ogTitle: Maybe<StringQueryOperatorInput>;
  readonly ogDescription: Maybe<StringQueryOperatorInput>;
  readonly ogType: Maybe<StringQueryOperatorInput>;
  readonly ogUrl: Maybe<StringQueryOperatorInput>;
...
type SiteFieldsEnum =
  ...
  | 'siteMetadata.bodyClass'
  | 'siteMetadata.lang'
  | 'siteMetadata.viewport'
  | 'siteMetadata.formatDetection'
  | 'siteMetadata.keywords'
  | 'siteMetadata.url'
  | 'siteMetadata.ogLocale'
...
type Unnamed_1_Query = { readonly images: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<File, 'relativePath' | 'name' | 'publicURL'>
        & { readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }
      ) }> } };

type LayoutTemplateQueryVariables = Exact<{ [key: string]: never; }>;


type LayoutTemplateQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'bodyClass' | 'viewport' | 'formatDetection' | 'lang' | 'title' | 'description' | 'keywords' | 'url' | 'ogLocale' | 'ogTitle' | 'ogType' | 'ogDescription' | 'ogUrl' | 'ogImage' | 'twitterCard'>> }> };
